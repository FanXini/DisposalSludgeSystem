...
<body>
	...
	<div id="selectMenu" class="selectMenu">
		...
		<button id="updateCarStatusButton" type="button" class="btn btn-info btn-circle btn-xl"
...
<script type="text/javascript">
  	...
  	function showWareHouse(){
		$.ajax({
  			...
  			success : function(list) {
  				...
  				myIcon = new BMap.Icon("img/warehouse.png", new BMap.Size(90, 75), {
	...
	function showMap(car) {
		...
		if(!jQuery.isEmptyObject(car.site)){
			var myIcon;
			myIcon = new BMap.Icon("img/factory"+car.site.status+".png", new BMap.Size(100, 70), {
