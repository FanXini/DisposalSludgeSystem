...
public interface SludgeDao {
	...
	public List<Sludge> queryAllSludgeByInOutFlagWithMinorWareHouseId(@Param("inOutFlag") int inOutFlag,
			@Param("minorWareHouseId") int minorWareHouseId);
	...
	public List<Sludge> querySludgeBySiteIdAndInOutFlagWithMinorWareHouseId(@Param("siteId") int siteId,
			@Param("inOutFlag") int inOutFlag, @Param("minorWareHouseId") int minorWareHouseId);

	/*
	 * public List<Sludge> querySludgeNotAssignFuncBySiteId(@Param("siteId") int
	 * siteId);
	 */

	public List<Sludge> querySludgeByDriverId(@Param("driverId") int driverId);

	public List<Sludge> querySludgeByDriverIdAndInOutFlagWithMinorWareHouseId(@Param("driverId") int driverId,
			@Param("inOutFlag") int inOutFlag, @Param("minorWareHouseId") int minorWareHouseId);

	/*
	 * public List<Sludge> querySludgeNotAssignFuncByDriverId(@Param("driverId") int
	 * driverId);
	 */

	public List<Sludge> querySludgeByDateAndInOutFlagWithMinorWareHouseId(@Param("startDate") String startDate,
			@Param("endDate") String endDate, @Param("inOutFlag") int inOutFlag,
			@Param("minorWareHouseId") int minorWareHouseId);

	public List<Sludge> querySludgeByDate(@Param("startDate") String startDate, @Param("endDate") String endDate);

	// public List<Sludge> querySludegNotAssignFuncByDate(@Param("startDate") String
	...
	public List<Sludge> querySludegByDateOfOneFactory(@Param("siteId") int siteId, @Param("startDate") String startDate,
			@Param("endDate") String endDate);

	public List<Sludge> querySludgeByDates(@Param("startDate") String startDate, @Param("endDate") String endDate,
	...
	public Sludge queryProcessingSludgeByCarIdAndStatus(@Param("transcarId") int transcarId);
