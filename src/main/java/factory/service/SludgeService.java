...
public interface SludgeService {
	...
	public List<Sludge> querySludgeBySiteIdAndInOutFlagWithMinorWareHouseId(int siteId, int inOuTflag,
			int minorWareHouseId);

	public List<Sludge> querySludgeByDriverId(int driverId);

	public List<Sludge> querySludgeByDriverIdAndInOutFlagWithMinorWareHouseId(int driverId, int inOutFlag,
			int minorWareHouseId);

	public List<Sludge> querySludgeByDateAndInOutFlagWithMinorWareHouseId(String startDate, String endDate,
			int inOutFlag, int minorWareHouseId);
