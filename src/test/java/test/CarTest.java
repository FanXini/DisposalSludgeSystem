...
/*	@Test
	...
	public  void fuzzyQueryCar(){
		List<Car> carWithDriver=carDao.fuzzyQueryCarWithDriver("��A");
		for(Car car:carWithDriver){
			System.out.println(car.getLicense()+"  "+car.getDriver().getRealname());
		}
		
		List<Car> carWithNoDriver=carDao.fuzzyQueryCarWithNoDriver("��A");
	...
	public void queryCarByLicense(){
		Car car=carDao.queryCarByLicense("��A56723");
		System.out.println(carList.size());
